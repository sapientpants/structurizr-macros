# Contributing to structurizr-macros

First and foremost, thank you! We appreciate that you want to contribute to structurizr-macros, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for structurizr-macros**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for structurizr-macros:

- star the [project](https://github.com/sapientpants/structurizr-macros)
- tweet your support for structurizr-macros
...
- **version**: (required) please note the version of structurizr-macros are you using
...
The original poster or the maintainers of structurizr-macros may close an issue at any time. Typically, but not exclusively, issues are closed when:
...
[so]: http://stackoverflow.com/questions/tagged/structurizr-macros
